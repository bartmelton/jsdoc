...
/** 
 * Adds a definition for exporting groups/types used by {@link getMembers}
 *
 ...
 * + events
 * 
 * @param {string} label The label for the type (e.g. "classes").
 * @param {object} value The value for the object.  Same as the second parameter of {@link find}.
 */	
exports.addMemberDefinition = function(label,value){
	memberDefinitions[label]=value;	
};

/** 
 * Allows you to relabel a definition for exporting groups/types used by {@link getMembers}
 *
 * @param {string} oldLabel The old label for the definition.
 * @param {object} newLabel The new label for the definition.
 */
exports.renameMemberDefinition = function(oldLabel,newLabel){
	memberDefinitions[newLabel]=memberDefinitions[oldLabel];
	delete memberDefinitions[oldLabel];
};
 ...
 * + Namespaces
 * + Events
 * + custom types  (see {@link addMemberDefinition})
 * @param {TAFFY} data The TaffyDB database to search.
...
exports.getMembers = function(data) {
    var members = {};
	for(let x in memberDefinitions){
		members[x]=find(data, memberDefinitions[x]);
	}
